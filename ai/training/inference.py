...
Outputs:
- Annotated prediction images → ai/outputs/inference/
- Detection summary JSON      → ai/outputs/inference/inference_report.json
"""
...
def main() -> int:
    ...
    output_dir = ensure_directory(config.yolo_output_path / "inference")
