...
export default function ManagerLogin() {
  ...
  const [email, setEmail] = useState('eleanor@retail.com');
  ...
  const fullPromptText = 'Ask RetaiLVision AI to analyze Manager store performance & task status...';
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative z-10">
        ...
        <div className="lg:col-span-5 max-w-md w-full mx-auto space-y-6 pr-0 lg:pr-2">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              <div className="w-11 h-11 rounded-2xl bg-gradient-to-tr from-[#9d4edd] via-[#f72585] to-[#7209b7] p-0.5 shadow-xl shadow-purple-500/20 flex items-center justify-center shrink-0">
                <div className="w-full h-full bg-[#0d0d11] rounded-[14px] flex items-center justify-center">
                  <ShieldCheck className="w-5.5 h-5.5 text-purple-400" />
                </div>
              </div>
              <div>
                <div className="text-[10px] font-extrabold uppercase tracking-widest text-purple-400 font-mono">RetaiLVision AI</div>
            ...
            <p className="text-xs text-purple-300/80 font-medium">
              Manager Workspace Login — Store Operations & Spatial AI
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 p-1 bg-[#17171c] border border-slate-800/80 rounded-full text-xs font-semibold">
            <button
              ...
              className={`py-2 rounded-full transition ${
                authMode === 'password' ? 'bg-purple-600 text-white shadow' : 'text-slate-400 hover:text-slate-200'
              }`}
            >
              Password Login
            </button>
            <button
              ...
              className={`py-2 rounded-full transition flex items-center justify-center gap-1.5 ${
                authMode === 'otp' ? 'bg-purple-600 text-white shadow' : 'text-slate-400 hover:text-slate-200'
              }`}
            >
            ...
            <form onSubmit={handleSubmitPassword} className="space-y-4 text-xs">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-[#17171c] border border-slate-800 rounded-full text-slate-100 placeholder:text-slate-500 focus:outline-none focus:border-purple-500 transition"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full px-4 py-3 bg-[#17171c] border border-slate-800 rounded-full text-slate-100 placeholder:text-slate-500 focus:outline-none focus:border-purple-500 transition pr-10"
                  />
                  <button
                    type="button"
              ...
              >
                <span>{loading ? 'Authenticating Manager...' : 'Continue to Manager Dashboard'}</span>
              </button>
            </form>
          ) : (
        ...
        <div className="lg:col-span-7 h-full min-h-[580px] hidden lg:block">
          <div className="w-full h-full rounded-[32px] overflow-hidden relative shadow-2xl p-8 flex items-center justify-center bg-gradient-to-tr from-[#0a0a16] via-[#1b1035] to-[#2e0938] border border-slate-800/50">
            ...
            <div className="absolute top-[10%] right-[10%] w-[380px] h-[380px] bg-gradient-to-tr from-purple-600 via-indigo-500 to-pink-500 rounded-full blur-[100px] opacity-70 animate-pulse pointer-events-none"></div>
            <div className="absolute bottom-[10%] left-[10%] w-[420px] h-[420px] bg-gradient-to-tr from-blue-600 via-purple-600 to-rose-500 rounded-full blur-[110px] opacity-80 animate-pulse pointer-events-none"></div>
