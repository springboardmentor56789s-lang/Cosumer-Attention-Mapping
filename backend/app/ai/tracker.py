...
class PersonTracker:
    ...
    def __init__(self):
        ...
        #
        # backend/runs/detect/tracked_video
        # =====================================================
    ...
    def track_video(
        ...
        # UNIQUE ANALYSIS ID
        #
        # Every analysis gets a different filename.
        # This prevents browser caching of old videos.
        # =====================================================
        ...
        # Previous vertical position of each shopper
        previous_positions = {}

        # Entry / exit line
        entry_exit_line_y = int(height * 0.5)
        ...
        # =====================================================
        # LAST GAZE RESULT FOR EACH PERSON
        # =====================================================
        ...
        try:
            ...
            for result in results:
                ...
                for index, track_id in enumerate(track_ids):
                    ...
                    #
                    # Upward crossing  = ENTRY
                    # Downward crossing = EXIT
                    # =================================================
                    ...
                    if track_id in previous_positions:
                        ...
                        if (
                            previous_y > entry_exit_line_y
                            and center_y <= entry_exit_line_y
                        ):
                    ...
                    if frame_count % path_interval == 0:
                        ...
                        if person_crop.size > 0:
                            ...
                            try:
                                ...
                                if gaze_results:
                                    ...
                                    # =====================================
                                    # FIND FACE CLOSEST TO PERSON CENTER
                                    # =====================================
                    ...
                    if (
                        ...
                        and gaze_y_normalized is not None
                    ):
        ...
        return {
            ...
            # TRACKING VIDEO
            #
            # ?v=timestamp prevents browser caching.
            # =================================================
